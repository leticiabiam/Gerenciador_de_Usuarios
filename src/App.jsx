...
//Chave de armazenamento simulada
const STORAGE_KEY = 'desafio_users_v1';

//Backend simulado básico (localStorage) com a mesma interface de uma API real.
const mockApi = {
  async list() {
...
//Alternar: usar API simulada (verdadeiro) ou API real (falso)
const USE_MOCK = true;

//Exemplo de wrapper de API real
...
//Exportar para XLSX com largura de coluna automática
...
export default function App() {
  ...
  async function handleCreateOrUpdate(e){
    ...
    //Verificação de e-mail exclusivo (interface do usuário)
